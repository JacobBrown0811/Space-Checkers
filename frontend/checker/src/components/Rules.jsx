...
<a href="/">
    ...
    A piece achieves the esteemed title of "Star Sovereign" if it reaches the last row of the opponent's cosmic quadrant, gaining the ability to move both forward and backward across the cosmic battlefield.
        <h2>Capture:</h2>Engage in cosmic conquest by capturing an opponent's piece. Leapfrog over an adversary's celestial entity when an empty space beckons beyond, securing victory in the name of your galactic empire. Be careful, traversal through the nebulas has disrupted IFF tracking! Friendly-fire is still possible!
    Coming Soon - Multi-Warp DLC: The cosmos applauds multiple captures in a single turn, allowing for a cascade of strategic moves in a continuous diagonal line or sucessive pattern.
